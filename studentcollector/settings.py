"""
Django settings for studentcollector project.
...
SECRET_KEY = 'django-insecure-r$oof_n(^tnt_^x*4*_yynyh&-@=xuffq&d*_c)=-@k@9rii^d'
...
ROOT_URLCONF = 'studentcollector.urls'
...
WSGI_APPLICATION = 'studentcollector.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        # 'USER': 'student_admin', <-- (optional) postgres user name, if you have to sign into an account to open psql, you will want to add that user name here.
